...
Dự án này hiện thực và thử nghiệm giải thuật **C\*** (*Coverage Path Planning for Unknown Environments using Rapidly Covering Graphs*), dựa trên bài báo của **Z. Shen, J. P. Wilson, S. Gupta**.
...
- Rapidly Covering Graph – RCG (màu đỏ)  
